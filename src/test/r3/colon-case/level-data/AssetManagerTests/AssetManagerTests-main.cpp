...
int main() {
	assert(testGetMapStatus_LoadingNotInitiated());
	assert(testGetMapStatus_LoadingInitiated());
	assert(testGetMapStatus_ErrorLoadingMap());
	assert(testGetMapStatus_ErrorLoadingTexture());

	assert(testDestructor_WaitsIfLoadingIncomplete());
